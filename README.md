...
Step 1) Ensure that REST Modular Input for Splunk is installed.
	http://apps.splunk.com/app/1546/ 

Step 2) Copy the inputs.conf.example file from: 
...
Step 3) Edit the new inputs.conf file. Update all fields wrapped in carrots: <example>
 
Step 4) Restart Splunk. $SPLUNK_HOME/bin/splunk restart 
